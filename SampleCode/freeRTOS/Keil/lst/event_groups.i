...
#line 82 "..\\Source\\event_groups.c"
#line 1 "..\\Source\\include\\event_groups.h"
...
#line 79 "..\\Source\\include\\event_groups.h"
...
#line 104 "..\\Source\\event_groups.c"
...
#line 170 "..\\Source\\event_groups.c"
...
#line 194 "..\\Source\\event_groups.c"
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) { __disable_irq(); for( ;; ); };
	if( ( uxBitsToWaitFor != 0 ) == 0 ) { __disable_irq(); for( ;; ); };
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if( ( xEventGroup ) == 0 ) { __disable_irq(); for( ;; ); };
	if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) { __disable_irq(); for( ;; ); };
	if( ( uxBitsToWaitFor != 0 ) == 0 ) { __disable_irq(); for( ;; ); };
...
EventBits_t uxReturn;
	...
	if( ( xEventGroup ) == 0 ) { __disable_irq(); for( ;; ); };
	if( ( ( uxBitsToClear & 0xff000000UL ) == 0 ) == 0 ) { __disable_irq(); for( ;; ); };
...
#line 512 "..\\Source\\event_groups.c"
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
	...
	if( ( xEventGroup ) == 0 ) { __disable_irq(); for( ;; ); };
	if( ( ( uxBitsToSet & 0xff000000UL ) == 0 ) == 0 ) { __disable_irq(); for( ;; ); };
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
	...
	vTaskSuspendAll();
	{
		...
		while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
		{
			...
			if( ( pxTasksWaitingForBits->xListEnd . pxNext != ( ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ) ) == 0 ) { __disable_irq(); for( ;; ); };
...
#line 661 "..\\Source\\event_groups.c"
	}
	( void ) xTaskResumeAll();
}
...
#line 730 "..\\Source\\event_groups.c"
